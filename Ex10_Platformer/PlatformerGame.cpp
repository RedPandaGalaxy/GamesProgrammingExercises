...
void PlatformerGame::initLevel() {
    ...
    auto bubbleSprite = spriteAtlas->get("110.png");
    ...
    bubbleObj2->name = "Bubble";
    auto bubbleSpriteComponent2 = bubbleObj2->addComponent<SpriteComponent>();
    auto bubbleSprite2 = spriteAtlas->get("111.png");
